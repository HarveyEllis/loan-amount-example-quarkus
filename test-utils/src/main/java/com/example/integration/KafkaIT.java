...
/**
 * We need this class to set up kafka producers and consumers. This means that we don't have to
 * create them again and again in our tests. See this class:
 * https://github.com/jeremyrdavis/quarkus-cafe-demo/blob/master/quarkus-cafe-test-utils/src/main/java/com/redhat/quarkus/cafe/infrastructure/KafkaIT.java
 */
public abstract class KafkaIT {

    protected static Collection<String> kafkaTopics =
            Arrays.asList("loan-offers-in", "loan-requests-in", "loans-available");
        ...
        kafkaTopics.forEach(
                topic -> {
                    ...
                    props.put(
                            ...
                            System.getProperty("KAFKA_BOOTSTRAP_SERVER"));
