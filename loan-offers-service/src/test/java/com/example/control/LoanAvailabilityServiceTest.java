...
class LoanAvailabilityServiceTest {
    ...
    @Inject LoanAvailabilityService sut;
    ...
    void givenANullItemThenAFalseLoanEventIsReturned() {
        ...
        when(loanOfferRepository.retrieveLoanOffersThatSumToAtLeastValue(any()))
                .thenReturn(uniLoanOffers);
        ...
        LoanAvailableEvent actual =
                sut.calculateLoanAvailability(new BigDecimal(1800), "requester")
                        .subscribe()
        ...
        assertThat(actual)
                ...
                .ignoringFields(
                        "monthlyRepayment", "totalRepayment", "loanOffers", "annualInterestRate")
                .isEqualTo(expected);
    ...
    void givenEnoughLoansToFulfilTheAmountThenATrueLoanEventIsReturned() {
        ...
        assertThat(actual)
                ...
                .ignoringFields(
                        "monthlyRepayment", "totalRepayment", "loanOffers", "annualInterestRate")
                .isEqualTo(expected);
        assertThat(actual.loanOffers).usingRecursiveComparison().isEqualTo(loanOfferList);
    }
}
