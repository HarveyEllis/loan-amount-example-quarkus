...
class LoanTest {
        ...
        return Stream.of(
                Arguments.of(
                        new Loan.LoanBuilder()
                                .setPrincipal(new BigDecimal("1000"))
                                .setYearlyRate(new BigDecimal("0.07"))
                                .setNumberOfPayments(36)
                                .setPaymentsPerAnnum(12)
                                .createLoan(),
                        new Loan.LoanBuilder()
                                .setPrincipal(new BigDecimal("1700"))
                                .setYearlyRate(new BigDecimal("0.072"))
                                .setNumberOfPayments(36)
                                .setPaymentsPerAnnum(12)
                                .createLoan(),
    ...
    private static Stream<Arguments> provideValuesForLoanAddition() {
        ...
        return Stream.of(
                Arguments.of(
                        loan1,
                        loan2,
                        new BigDecimal("0.005753"),
                        new BigDecimal("2700.00"),
                        new BigDecimal("2996.96"),
    ...
    private static Stream<Arguments> provideValuesForLoanReduction() {
        Loan loan1 =
                new Loan.LoanBuilder()
                        .setPrincipal(new BigDecimal("480"))
                        .setYearlyRate(new BigDecimal("0.069"))
                        .setNumberOfPayments(36)
                        .setPaymentsPerAnnum(12)
                        .createLoan();
        Loan loan2 =
                new Loan.LoanBuilder()
                        .setPrincipal(new BigDecimal("520"))
                        .setYearlyRate(new BigDecimal("0.071"))
                        .setNumberOfPayments(36)
                        .setPaymentsPerAnnum(12)
                        .createLoan();
        Loan loan3 =
                new Loan.LoanBuilder()
                        .setPrincipal(new BigDecimal("60"))
                        .setYearlyRate(new BigDecimal("0.071"))
                        .setNumberOfPayments(36)
                        .setPaymentsPerAnnum(12)
                        .createLoan();
        Loan loan4 =
                new Loan.LoanBuilder()
                        .setPrincipal(new BigDecimal("140"))
                        .setYearlyRate(new BigDecimal("0.074"))
                        .setNumberOfPayments(36)
                        .setPaymentsPerAnnum(12)
                        .createLoan();
        Loan loan5 =
                new Loan.LoanBuilder()
                        .setPrincipal(new BigDecimal("500"))
                        .setYearlyRate(new BigDecimal("0.075"))
                        .setNumberOfPayments(36)
                        .setPaymentsPerAnnum(12)
                        .createLoan();
        ...
        return Stream.of(
                Arguments.of(
                        ...
                        new BigDecimal("0.005800"),
                        new BigDecimal("1700.00"),
                        new BigDecimal("1888.55"),
    ...
    private static Stream<Arguments> provideValuesForRatesRepayments() {
        return Stream.of(
                Arguments.of(
                        new BigDecimal(1000), new BigDecimal("0.005654"), new BigDecimal("30.78")),
                Arguments.of(
                        new BigDecimal(1700), new BigDecimal("0.005811"), new BigDecimal("52.47")),
                Arguments.of(
                        new BigDecimal(2500), new BigDecimal("0.007974"), new BigDecimal("80.16")));
    }
    ...
    void givenTwoLoansBlendedRateIsCalculatedCorrectly(
            Loan firstLoan, Loan secondLoan, BigDecimal expectedBlendedRate) {

        assertThat(Loan.calculateBlendedYearlyRate(firstLoan, secondLoan).round(fourSf))
                .isEqualTo(expectedBlendedRate);
    }

    @ParameterizedTest
    @MethodSource("provideValuesForLoanAddition")
    void givenTwoLoansTheirSumIsMadeCorrectly(
            Loan firstLoan,
            Loan secondLoan,
            ...
            throws IncompatibleLoanTermsException {
        ...
        assertThat(actual.getTotalRepayment().setScale(2, RoundingMode.HALF_UP))
                .isEqualTo(totalRepayment);
        assertThat(actual.getMonthlyRepayment().setScale(2, RoundingMode.HALF_UP))
                .isEqualTo(monthlyRepayment);
    }

    @ParameterizedTest
    @MethodSource("provideValuesForLoanReduction")
    void givenAListOfLoansWhenReducedTheyReduceCorrectly(
            List<Loan> loans,
            BigDecimal periodicRate,
            BigDecimal principal,
            BigDecimal totalRepayment,
    ...
    void givenASingleLoanOfferThenServiceReturnsCorrectRatesAndRepayments(
    ...
    void givenAMonthlyRepaymentThenTotalRepaymentCalculatedCorrectly(
            BigDecimal monthlyRepayment,
